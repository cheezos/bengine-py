...
class Model:
    def __init__(self, model_path: str) -> None:
        ...
        # GL.glVertexAttribPointer(0, 3, GL.GL_FLOAT, GL.GL_FALSE, self._vertices.itemsize * 8, ctypes.c_vertex_objectsid_p(0))

        # # Vertex Texture Coordinates
        # GL.glEnableVertexAttribArray(1)
        # GL.glVertexAttribPointer(1, 2, GL.GL_FLOAT, GL.GL_FALSE, self._vertices.itemsize * 8, ctypes.c_vertex_objectsid_p(12))
        
        # # Vertex Normal Coordinates
        # GL.glEnableVertexAttribArray(2)
        # GL.glVertexAttribPointer(2, 3, GL.GL_FLOAT, GL.GL_FALSE, self._vertices.itemsize * 8, ctypes.c_vertex_objectsid_p(20))
